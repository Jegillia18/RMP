...
for i=ind:length(Marker_y)-1
    if Marker_y(i) < (Marker_mean ) && Marker_y(i+1) < ...
            ...
            (Marker_mean ) && Marker_y(i+4) < (Marker_mean ) && Marker_y(i+5)< ...
            ...
            (Marker_mean ) && Marker_y(i+10) < (Marker_mean ) && Marker_y(i+11)<...
             ...
             (Marker_mean ) && Marker_y(i+14) < (Marker_mean ) && Marker_y(i+15)<(Marker_mean)                                                %Variable x will be saved at current i.
